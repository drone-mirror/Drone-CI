...
git clone https://github.com/Nicklas373/kernel_xiaomi_lavender -b dev/yukina lavender
...
# Kernel aliases
COMMIT="92305d57fe629034230436f2d95500bff4561c06"
...
function compile() {
	bot_first_compile
	START=$(date +"%s")
	make -s -C ${KERNEL} lavender-perf_defconfig
